...
const PaymentMethod = (props: {data: ProducerType}) => {
    console.log(props.data)
    return (
        <div className="w-full bg-white p-4 mt-6">
            <p className="border-b-2 pb-2 mb-4">支払い方法変更</p>
            <RadioBox label={'銀行振込'} name={'paymentMethod'} id={'bank'} value={0} defaultChecked={props.data.paymentMethod === 0}/>
            <RadioBox label={'クレジットカード'} name={'paymentMethod'} id={'creditCard'} value={1} defaultChecked={props.data.paymentMethod === 1}/>
